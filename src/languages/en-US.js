...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMANDMESSAGE_MISSING_REQUIRED: (name) => `｢ **Error** ｣ A \`${name}\` is a required argument for this command. Check p!help <command> for usage.`,
			...
			COMMAND_DMSONG_DESCRIPTION: 'Make me send you the current song in your DMs.',
			COMMAND_LOOP_DESCRIPTION: 'Loop a song so it repeats when it finishes playing.',
			COMMAND_LYRICS_DESCRIPTION: "Get a song's lyrics directly <CURRENTLY UNUSABLE>.",
			...
			COMMAND_MAKE_DJ_DESCRPTION: 'Make a user DJ if you are Mod or above.',
			COMMAND_LEAVE_DESCRIPTION: 'Make me leave your Voice Channel.',
			COMMAND_PAUSE_DESCRIPTION: 'Pause/Resume the currently playing music.',
			COMMAND_VOLUME_DESCRIPTION: 'Change the default volume of in your guild',
			...
			COMMAND_JOIN_DESCRIPTION: 'Join your current voice channel.',
